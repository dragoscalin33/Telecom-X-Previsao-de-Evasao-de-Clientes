...
TelecomX_Evasao_Clientes: Notebook/script da Parte 1, responsável pelo carregamento, limpeza e pré-processamento dos dados, salvando o resultado em telecomX_datos.csv.

TelecomX_Previsao-de-Evasao-de-Clientes: Notebook/script da Parte 2, que carrega os dados processados e executa as etapas de modelagem, avaliação e análise de importância de variáveis.
